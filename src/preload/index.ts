...
const api: BeatStrideApi = {
  ...
  selectFfmpegPath: () => ipcRenderer.invoke(IPC_CHANNELS.dialogSelectFfmpegPath),
  selectFfprobePath: () => ipcRenderer.invoke(IPC_CHANNELS.dialogSelectFfprobePath),
  selectMetronomeSamplePath: () => ipcRenderer.invoke(IPC_CHANNELS.dialogSelectMetronomeSample),
  ...
  analyzeTracks: (payload) => ipcRenderer.invoke(IPC_CHANNELS.audioAnalyzeTracks, payload),
  suggestTrackAlignments: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.audioSuggestTrackAlignments, payload),
  ...
  prepareSinglePreviewAudio: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.audioPrepareSinglePreview, payload),
  prepareMedleyPreviewAudio: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.audioPrepareMedleyPreview, payload),
  generateTrackProxies: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.audioGenerateTrackProxies, payload),
  getTrackProxyStatuses: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.audioGetTrackProxyStatuses, payload),
