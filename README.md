...
- 工作区试听：
  ...
  - 原曲对比 / 变速试听 / 节拍器叠加
  - 模式热切换
  - 图标化控制台：后退 10 秒 / 播放 / 暂停 / 停止 / 前进 10 秒
  - 暂停与停止分离：暂停保留当前位置，停止回到起点
  - 音量控制
  - 进度条点击、拖动定位与已播放区间填充
  - 进度状态提示与试听建议卡
- 节拍器逻辑：
...
5. 在下方工作区进行单曲或串烧试听，必要时热切换原曲、变速和节拍器模式，并用 `后退/前进 10 秒`、进度条和暂停/停止快速校对听感
...
- 第一行用于选择试听目标与模式：`单曲 / 串烧`、`变速 / 节拍器 / 原曲`
- 第二行提供传输控制与音量：`后退 10 秒 / 播放 / 暂停 / 停止 / 前进 10 秒`
- 第三行提供进度条与时间显示，支持点击或拖动跳转，轨道会显示已播放区间
- 进度条下方会显示当前状态，例如 `试听中 / 已暂停 / 待命`
- 下方建议卡会根据当前歌曲、模式、代理状态和工作区情况，提示优先检查的内容，例如目标 BPM、首拍偏移和节拍器偏移
